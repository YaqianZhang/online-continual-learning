...
class ER_dyna_iter_aug_only(ExperienceReplay):
    def __init__(self, model, opt, params):
        super(ER_dyna_iter_aug_only, self).__init__(model, opt, params)
    ...
    def train_learner(self, x_train, y_train):
        ...
        for ep in range(self.epoch):
            for i, batch_data in enumerate(train_loader):
                ...
                memiter = 10
                    #self.set_dyna_iter(self.memory_manager.current_performance,STOP_FLAG)
