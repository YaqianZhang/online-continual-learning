    ...
    def train_learner(self, x_train, y_train):
        ...
        for ep in range(self.epoch):
            for i, batch_data in enumerate(train_loader):
                ...
                scr_loss,combined_batch,combined_labels,mem_num  = self._scr_train(batch_x, batch_y, losses)

                softmax_loss, acc_incoming, incoming_loss= self.perform_softmax_training(combined_batch,
                                                                                          combined_labels,
                                                                                          mem_num)
