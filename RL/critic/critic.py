...
class critic_class(object):
    ...
    def load_critic_model(self, model):
        ...
        prefix= "ER_RL_addIter_stop1_ran_ran_raug114_NMC_mIter20_iter_201_test_acc_0_train_test4_Done249_bstart0_exp_pe_crt32_3_0.0001_random_memBch100_numRuns3_nc"

        #prefix = "ER_RL_addIter_stop3_ran_ran_raug114_NMC_mIter20_iter_201_test_acc_0_train_test4_Done249_bstart0_exp_pe_crt32_3_0.0001_memBch100_nc"
        if(self.params.preload_type =="cifar100"):
            prefix += "_20_2000_cifar100_RLmodel"

        elif(self.params.preload_type =="mini_imagenet"):

            prefix += "_10_2000_mini_imagenet_RLmodel"
        ...
        checkpoint = torch.load(PATH,map_location={'cuda:3':'cuda:'+str(self.params.GPU_ID)})
    ...
    def train_batch(self,state_batch,action_batch,reward_batch,next_state_batch,done_batch,training_steps):
        ...
        # print(q_values.shape,state_batch.shape)
        # assert False
