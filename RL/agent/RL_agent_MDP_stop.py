...
class RL_MDP_agent_stop(RL_memIter_agent):
    ## sample action;
    ## udpate RL agent
    ...
    def sample_action(self, state):
        ...
        self.epsilon = 1/self.RL_running_steps # todo dynamic epsilon
        ...
        if(self.params.critic_use_model):
            ...
            if(rnd<self.epsilon ):# (self.RL_running_steps < self.critic_training_start)): ## take random action
