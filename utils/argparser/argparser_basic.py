...
def parse_cl_basic(parser):
    ...
    parser.add_argument('--agent', dest='agent', default='ER',
                        choices=["DERPP_head_t1","DER_head_t1","DERPP","DERPP_head","SCR_der","DER_head","SCR_spread","SCR_spread_class","ER_ratio2","ER_ratio3","DER","ER_test","ER_compress_both","ER_compress","ER_offline", 'LAMAML', 'RLER', 'ER',"ER_cl_bandits","ER_cl_bandits_ts", "ER_batchsize","ER_ratio","ER_aug", "ER_cl", "ER_RL_ratio",
