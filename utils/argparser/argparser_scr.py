...
def parse_scr(parser):
    ...
    parser.add_argument('--self_sup_beta',type=float,default = 0.0)

    parser.add_argument('--phead_layer',type=int,default=1)
    parser.add_argument('--phead_size',type=int,default=1024)
